...
const Header: React.FC<HeaderProps> = ({ currentPage, setPage, theme, toggleTheme, currentUser, onLoginClick, onLogoutClick, topOffset = 0 }) => {
  ...
  return (
    <header
      style={{ top: topOffset }}
      className={`fixed left-0 right-0 z-[100] transition-all duration-500 ${isScrolled ? 'py-4 bg-bgMain/90 backdrop-blur-xl border-b border-borderColor shadow-2xl' : 'py-7 bg-transparent'}`}
    >
